...
func NewPgPlanRepo(db *sql.DB) SubscriptionPlanRepository {
	return &pgPlanRepo{db: db}
}

func (r *pgPlanRepo) Create(ctx context.Context, plan SubscriptionPlan) (*SubscriptionPlan, error) {
	q := `
...
func (r *pgPlanRepo) GetByID(ctx context.Context, id string) (*SubscriptionPlan, error) {
	q := `
...
func (r *pgPlanRepo) GetByCode(ctx context.Context, code string, entityType string) (*SubscriptionPlan, error) {
	q := `
		SELECT id, code, name, description, entity_type, features,
		       price_monthly, price_yearly, currency, max_members, max_tournaments,
		       max_athletes, is_active, sort_order, created_at, updated_at
...
func (r *pgPlanRepo) List(ctx context.Context, entityType string) ([]SubscriptionPlan, error) {
	q := `
		SELECT id, code, name, description, entity_type, features,
		       price_monthly, price_yearly, currency, max_members, max_tournaments,
		       max_athletes, is_active, sort_order, created_at, updated_at
...
func NewPgSubRepo(db *sql.DB) SubscriptionRepository {
	return &pgSubRepo{db: db}
}

func (r *pgSubRepo) Create(ctx context.Context, sub Subscription) (*Subscription, error) {
	q := `
...
func (r *pgSubRepo) GetByID(ctx context.Context, id string) (*Subscription, error) {
	q := `
...
func (r *pgSubRepo) GetByEntity(ctx context.Context, entityType, entityID string) (*Subscription, error) {
	q := `
		SELECT id, plan_id, plan_code, plan_name, entity_type, entity_id, entity_name,
		       status, billing_cycle_type, current_period_start::text, current_period_end::text, 
		       trial_end_date::text, cancelled_at, cancel_reason, auto_renew,
...
func (r *pgSubRepo) List(ctx context.Context, filter SubscriptionFilter) ([]Subscription, error) {
	q := `
		SELECT id, plan_id, plan_code, plan_name, entity_type, entity_id, entity_name,
		       status, billing_cycle_type, current_period_start::text, current_period_end::text, 
		       trial_end_date::text, cancelled_at, cancel_reason, auto_renew,
...
func NewPgBillingRepo(db *sql.DB) BillingCycleRepository {
	return &pgBillingRepo{db: db}
}

func (r *pgBillingRepo) Create(ctx context.Context, bc BillingCycle) (*BillingCycle, error) {
	q := `
...
func (r *pgBillingRepo) GetByID(ctx context.Context, id string) (*BillingCycle, error) {
	q := `
...
func (r *pgBillingRepo) ListBySubscription(ctx context.Context, subID string) ([]BillingCycle, error) {
	q := `
		SELECT id, subscription_id, period_start::text, period_end::text, amount,
		       currency, invoice_id, status, due_date::text, paid_at, created_at, updated_at
		FROM platform.billing_cycles
...
func (r *pgBillingRepo) List(ctx context.Context, filter BillingCycleFilter) ([]BillingCycle, error) {
	q := `
		SELECT id, subscription_id, period_start::text, period_end::text, amount,
		       currency, invoice_id, status, due_date::text, paid_at, created_at, updated_at
		FROM platform.billing_cycles
...
func NewPgRenewalRepo(db *sql.DB) RenewalLogRepository {
	return &pgRenewalRepo{db: db}
}

func (r *pgRenewalRepo) Create(ctx context.Context, log RenewalLog) (*RenewalLog, error) {
	q := `
...
func (r *pgRenewalRepo) ListBySubscription(ctx context.Context, subID string) ([]RenewalLog, error) {
	q := `
