...
func NewInMemPlanRepo() SubscriptionPlanRepository {
	return &inMemPlanRepo{plans: make(map[string]*SubscriptionPlan)}
}

func (r *inMemPlanRepo) Create(_ context.Context, plan SubscriptionPlan) (*SubscriptionPlan, error) {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *inMemPlanRepo) GetByID(_ context.Context, id string) (*SubscriptionPlan, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
	p, ok := r.plans[id]
	if !ok {
...
func (r *inMemPlanRepo) GetByCode(_ context.Context, code string, entityType string) (*SubscriptionPlan, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r *inMemPlanRepo) List(_ context.Context, entityType string) ([]SubscriptionPlan, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func NewInMemSubRepo() SubscriptionRepository {
	return &inMemSubRepo{subs: make(map[string]*Subscription)}
}

func (r *inMemSubRepo) Create(_ context.Context, sub Subscription) (*Subscription, error) {
	r.mu.Lock()
	defer r.mu.Unlock()
	r.subs[sub.ID] = &sub
	return &sub, nil
...
func (r *inMemSubRepo) GetByID(_ context.Context, id string) (*Subscription, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
	s, ok := r.subs[id]
	if !ok {
...
func (r *inMemSubRepo) GetByEntity(_ context.Context, entityType, entityID string) (*Subscription, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r *inMemSubRepo) List(_ context.Context, filter SubscriptionFilter) ([]Subscription, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func NewInMemBillingRepo() BillingCycleRepository {
	return &inMemBillingRepo{cycles: make(map[string]*BillingCycle)}
}

func (r *inMemBillingRepo) Create(_ context.Context, bc BillingCycle) (*BillingCycle, error) {
	r.mu.Lock()
	defer r.mu.Unlock()
	r.cycles[bc.ID] = &bc
	return &bc, nil
...
func (r *inMemBillingRepo) GetByID(_ context.Context, id string) (*BillingCycle, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
	bc, ok := r.cycles[id]
	if !ok {
...
func (r *inMemBillingRepo) ListBySubscription(_ context.Context, subID string) ([]BillingCycle, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r *inMemBillingRepo) List(_ context.Context, filter BillingCycleFilter) ([]BillingCycle, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
	var out []BillingCycle
	for _, bc := range r.cycles {
...
func NewInMemRenewalRepo() RenewalLogRepository {
	return &inMemRenewalRepo{logs: make(map[string]*RenewalLog)}
}

func (r *inMemRenewalRepo) Create(_ context.Context, log RenewalLog) (*RenewalLog, error) {
	r.mu.Lock()
	defer r.mu.Unlock()
	r.logs[log.ID] = &log
	return &log, nil
...
func (r *inMemRenewalRepo) ListBySubscription(_ context.Context, subID string) ([]RenewalLog, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
	var out []RenewalLog
