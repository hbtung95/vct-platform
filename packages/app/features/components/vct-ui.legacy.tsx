            ...
            {isOpen ? (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed left-1/2 top-1/2 z-[410] w-[calc(100vw-24px)] max-h-[90vh] -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-2xl border border-vct-border bg-vct-elevated shadow-[var(--vct-shadow-xl)]"
        ...
        <AnimatePresence>
            {isVisible ? (
                <motion.div
                    role="status"
                    aria-live="polite"
                    className={`fixed bottom-4 right-4 z-[500] max-w-[420px] rounded-xl border px-3 py-2 text-sm font-semibold shadow-[var(--vct-shadow-lg)] ${TONE[type] || TONE.success}`}
